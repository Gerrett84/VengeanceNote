...
# instance fields
.field final IR:Landroid/content/pm/IPackageStatsObserver$Stub;
...
.method constructor <init>(Lcom/android/settings/applications/ApplicationsState;Landroid/os/Looper;)V
    ...
    .prologue
    .line 872
    iput-object p1, p0, Lcom/android/settings/applications/ApplicationsState$BackgroundHandler;->iG:Lcom/android/settings/applications/ApplicationsState;
    ...
    iput-object v0, p0, Lcom/android/settings/applications/ApplicationsState$BackgroundHandler;->IR:Landroid/content/pm/IPackageStatsObserver$Stub;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 880
    iget-object v1, p0, Lcom/android/settings/applications/ApplicationsState$BackgroundHandler;->iG:Lcom/android/settings/applications/ApplicationsState;
    ...
    .line 881
    :try_start_0
    iget-object v3, p0, Lcom/android/settings/applications/ApplicationsState$BackgroundHandler;->iG:Lcom/android/settings/applications/ApplicationsState;

    iget-object v3, v3, Lcom/android/settings/applications/ApplicationsState;->GY:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Lcom/android/settings/applications/ApplicationsState$Session;->eY()V
    ...
    .line 897
    :pswitch_1
    iget-object v0, p0, Lcom/android/settings/applications/ApplicationsState$BackgroundHandler;->iG:Lcom/android/settings/applications/ApplicationsState;

    iget-object v3, v0, Lcom/android/settings/applications/ApplicationsState;->GZ:Ljava/util/HashMap;
    ...
    iget-object v0, v0, Lcom/android/settings/applications/ApplicationsState;->Hb:Ljava/util/List;
    ...
    .line 904
    iget-object v4, p0, Lcom/android/settings/applications/ApplicationsState$BackgroundHandler;->iG:Lcom/android/settings/applications/ApplicationsState;

    iget-object v4, v4, Lcom/android/settings/applications/ApplicationsState;->Hg:Lcom/android/settings/applications/ApplicationsState$MainHandler;
    ...
    iget-object v4, v4, Lcom/android/settings/applications/ApplicationsState;->GZ:Ljava/util/HashMap;
    ...
    iget-object v0, v0, Lcom/android/settings/applications/ApplicationsState;->Ha:Ljava/util/ArrayList;
    ...
    iget-boolean v4, v0, Lcom/android/settings/applications/ApplicationsState$AppEntry;->hL:Z
    ...
    iget-object v5, p0, Lcom/android/settings/applications/ApplicationsState$BackgroundHandler;->iG:Lcom/android/settings/applications/ApplicationsState;

    iget-object v5, v5, Lcom/android/settings/applications/ApplicationsState;->be:Landroid/content/pm/PackageManager;
    ...
    iget-object v5, v5, Lcom/android/settings/applications/ApplicationsState;->Hg:Lcom/android/settings/applications/ApplicationsState$MainHandler;
    ...
    iget-boolean v5, v0, Lcom/android/settings/applications/ApplicationsState$AppEntry;->hQ:Z

    if-eqz v5, :cond_10

    .line 966
    :cond_c
    iget-wide v5, v0, Lcom/android/settings/applications/ApplicationsState$AppEntry;->hR:J
    ...
    .line 970
    iget-object v2, p0, Lcom/android/settings/applications/ApplicationsState$BackgroundHandler;->iG:Lcom/android/settings/applications/ApplicationsState;
    ...
    iput-object v0, v2, Lcom/android/settings/applications/ApplicationsState;->Hd:Ljava/lang/String;

    .line 976
    iget-object v0, p0, Lcom/android/settings/applications/ApplicationsState$BackgroundHandler;->iG:Lcom/android/settings/applications/ApplicationsState;

    iget-object v0, v0, Lcom/android/settings/applications/ApplicationsState;->be:Landroid/content/pm/PackageManager;

    iget-object v2, p0, Lcom/android/settings/applications/ApplicationsState$BackgroundHandler;->iG:Lcom/android/settings/applications/ApplicationsState;

    iget-object v2, v2, Lcom/android/settings/applications/ApplicationsState;->Hd:Ljava/lang/String;

    iget-object v3, p0, Lcom/android/settings/applications/ApplicationsState$BackgroundHandler;->IR:Landroid/content/pm/IPackageStatsObserver$Stub;
