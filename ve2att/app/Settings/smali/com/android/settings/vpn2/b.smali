...
.field private final sf:Landroid/content/DialogInterface$OnClickListener;

.field private tA:Landroid/widget/Spinner;

.field private tB:Landroid/widget/Spinner;

.field private tC:Landroid/widget/Spinner;

.field private tD:Landroid/widget/CheckBox;

.field private tn:Z

.field private to:Landroid/widget/TextView;

.field private tp:Landroid/widget/Spinner;
...
.field private tw:Landroid/widget/CheckBox;
...
.method constructor <init>(Landroid/content/Context;Landroid/content/DialogInterface$OnClickListener;Lcom/android/settings/vpn2/c;Z)V
    ...
    .line 70
    iput-object p2, p0, Lcom/android/settings/vpn2/b;->sf:Landroid/content/DialogInterface$OnClickListener;

    .line 71
    iput-object p3, p0, Lcom/android/settings/vpn2/b;->dX:Lcom/android/settings/vpn2/c;

    .line 72
    iput-boolean p4, p0, Lcom/android/settings/vpn2/b;->tn:Z
...
.method private H(Z)Z
    ...
    iget-object v2, p0, Lcom/android/settings/vpn2/b;->ts:Landroid/widget/TextView;
    ...
    .line 255
    :cond_2
    iget-object v2, p0, Lcom/android/settings/vpn2/b;->to:Landroid/widget/TextView;
    ...
    .line 260
    :cond_4
    iget-object v2, p0, Lcom/android/settings/vpn2/b;->tp:Landroid/widget/Spinner;
    ...
    .line 267
    :pswitch_1
    iget-object v2, p0, Lcom/android/settings/vpn2/b;->tz:Landroid/widget/TextView;
    ...
    .line 271
    :pswitch_2
    iget-object v2, p0, Lcom/android/settings/vpn2/b;->tA:Landroid/widget/Spinner;
...
.method private af(I)V
    ...
    .line 220
    iget-object v0, p0, Lcom/android/settings/vpn2/b;->tw:Landroid/widget/CheckBox;
...
.method ad()Lcom/android/settings/vpn2/c;
    ...
    .line 337
    iget-object v0, p0, Lcom/android/settings/vpn2/b;->to:Landroid/widget/TextView;
    ...
    .line 338
    iget-object v0, p0, Lcom/android/settings/vpn2/b;->tp:Landroid/widget/Spinner;
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lcom/android/settings/vpn2/b;->tD:Landroid/widget/CheckBox;
    ...
    .line 357
    iget-object v0, p0, Lcom/android/settings/vpn2/b;->tz:Landroid/widget/TextView;
    ...
    .line 372
    :cond_2
    iget-object v0, p0, Lcom/android/settings/vpn2/b;->tC:Landroid/widget/Spinner;
...
.method public afterTextChanged(Landroid/text/Editable;)V
    ...
    iget-boolean v1, p0, Lcom/android/settings/vpn2/b;->tn:Z
...
.method fw()Z
    ...
    .prologue
    .line 331
    iget-boolean v0, p0, Lcom/android/settings/vpn2/b;->tn:Z
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/vpn2/b;->to:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/android/settings/vpn2/b;->tp:Landroid/widget/Spinner;
    ...
    iput-object v0, p0, Lcom/android/settings/vpn2/b;->tw:Landroid/widget/CheckBox;
    ...
    iput-object v0, p0, Lcom/android/settings/vpn2/b;->tz:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lcom/android/settings/vpn2/b;->tC:Landroid/widget/Spinner;
    ...
    iput-object v0, p0, Lcom/android/settings/vpn2/b;->tD:Landroid/widget/CheckBox;
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/settings/vpn2/b;->tn:Z
    ...
    iget-object v2, p0, Lcom/android/settings/vpn2/b;->sf:Landroid/content/DialogInterface$OnClickListener;
    ...
    iget-object v4, p0, Lcom/android/settings/vpn2/b;->sf:Landroid/content/DialogInterface$OnClickListener;
