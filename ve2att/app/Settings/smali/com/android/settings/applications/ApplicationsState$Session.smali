...
.field final rD:Lcom/android/settings/applications/ApplicationsState$Callbacks;

.field final rE:Ljava/lang/Object;

.field rF:Z

.field rG:Z

.field rH:Lcom/android/settings/applications/ApplicationsState$AppFilter;

.field rI:Ljava/util/Comparator;

.field rJ:Ljava/util/ArrayList;

.field rK:Ljava/util/ArrayList;
...
.method constructor <init>(Lcom/android/settings/applications/ApplicationsState;Lcom/android/settings/applications/ApplicationsState$Callbacks;)V
    ...
    iput-object v0, p0, Lcom/android/settings/applications/ApplicationsState$Session;->rE:Ljava/lang/Object;

    .line 441
    iput-object p2, p0, Lcom/android/settings/applications/ApplicationsState$Session;->rD:Lcom/android/settings/applications/ApplicationsState$Callbacks;
...
.method a(Lcom/android/settings/applications/ApplicationsState$AppFilter;Ljava/util/Comparator;)Ljava/util/ArrayList;
    ...
    .prologue
    .line 471
    iget-object v1, p0, Lcom/android/settings/applications/ApplicationsState$Session;->rE:Ljava/lang/Object;
    ...
    iput-boolean v0, p0, Lcom/android/settings/applications/ApplicationsState$Session;->rG:Z

    .line 476
    iput-object p1, p0, Lcom/android/settings/applications/ApplicationsState$Session;->rH:Lcom/android/settings/applications/ApplicationsState$AppFilter;

    .line 477
    iput-object p2, p0, Lcom/android/settings/applications/ApplicationsState$Session;->rI:Ljava/util/Comparator;

    .line 478
    const/4 v0, 0x0

    iput-object v0, p0, Lcom/android/settings/applications/ApplicationsState$Session;->rJ:Ljava/util/ArrayList;
    ...
    .line 489
    :goto_0
    iget-object v0, p0, Lcom/android/settings/applications/ApplicationsState$Session;->rJ:Ljava/util/ArrayList;
    ...
    :cond_2
    :try_start_5
    iget-object v0, p0, Lcom/android/settings/applications/ApplicationsState$Session;->rE:Ljava/lang/Object;
...
.method eY()V
    ...
    .line 510
    :try_start_0
    iget-boolean v2, p0, Lcom/android/settings/applications/ApplicationsState$Session;->rF:Z
    ...
    .line 514
    :cond_0
    iget-object v2, p0, Lcom/android/settings/applications/ApplicationsState$Session;->rH:Lcom/android/settings/applications/ApplicationsState$AppFilter;

    .line 515
    iget-object v3, p0, Lcom/android/settings/applications/ApplicationsState$Session;->rI:Ljava/util/Comparator;

    .line 516
    const/4 v4, 0x0

    iput-boolean v4, p0, Lcom/android/settings/applications/ApplicationsState$Session;->rF:Z

    .line 517
    const/4 v4, 0x0

    iput-object v4, p0, Lcom/android/settings/applications/ApplicationsState$Session;->rH:Lcom/android/settings/applications/ApplicationsState$AppFilter;

    .line 518
    const/4 v4, 0x0

    iput-object v4, p0, Lcom/android/settings/applications/ApplicationsState$Session;->rI:Ljava/util/Comparator;
    ...
    .line 552
    iput-object v5, p0, Lcom/android/settings/applications/ApplicationsState$Session;->rK:Ljava/util/ArrayList;

    .line 553
    iget-boolean v0, p0, Lcom/android/settings/applications/ApplicationsState$Session;->rG:Z
