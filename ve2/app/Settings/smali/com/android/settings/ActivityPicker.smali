...
# instance fields
.field private sk:Lcom/android/settings/dc;

.field private sl:Landroid/content/Intent;
...
# virtual methods
.method protected V(I)Landroid/content/Intent;
    .locals 2
    .parameter

    .prologue
    .line 129
    iget-object v0, p0, Lcom/android/settings/ActivityPicker;->sk:Lcom/android/settings/dc;

    invoke-virtual {v0, p1}, Lcom/android/settings/dc;->getItem(I)Ljava/lang/Object;
    ...
    .line 130
    iget-object v1, p0, Lcom/android/settings/ActivityPicker;->sl:Landroid/content/Intent;

    invoke-virtual {v0, v1}, Lcom/android/settings/dM;->k(Landroid/content/Intent;)Landroid/content/Intent;
...
.method protected a(Landroid/content/Intent;Ljava/util/List;)V
    ...
    .line 191
    new-instance v5, Lcom/android/settings/dM;

    invoke-direct {v5, p0, v2, v0}, Lcom/android/settings/dM;-><init>(Landroid/content/Context;Landroid/content/pm/PackageManager;Landroid/content/pm/ResolveInfo;)V
...
.method protected ea()Ljava/util/List;
    .locals 11
    ...
    .line 167
    :goto_1
    new-instance v8, Lcom/android/settings/dM;

    invoke-direct {v8, p0, v0, v1}, Lcom/android/settings/dM;-><init>(Landroid/content/Context;Ljava/lang/CharSequence;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 172
    :cond_0
    iget-object v0, p0, Lcom/android/settings/ActivityPicker;->sl:Landroid/content/Intent;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    .prologue
    .line 111
    invoke-virtual {p0, p2}, Lcom/android/settings/ActivityPicker;->V(I)Landroid/content/Intent;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/ActivityPicker;->sl:Landroid/content/Intent;

    .line 87
    :goto_0
    iget-object v0, p0, Lcom/android/settings/ActivityPicker;->mAlertParams:Lcom/android/internal/app/AlertController$AlertParams;
    ...
    .line 99
    :goto_1
    invoke-virtual {p0}, Lcom/android/settings/ActivityPicker;->ea()Ljava/util/List;

    move-result-object v1

    .line 100
    new-instance v2, Lcom/android/settings/dc;

    invoke-direct {v2, p0, v1}, Lcom/android/settings/dc;-><init>(Landroid/content/Context;Ljava/util/List;)V

    iput-object v2, p0, Lcom/android/settings/ActivityPicker;->sk:Lcom/android/settings/dc;

    .line 101
    iget-object v1, p0, Lcom/android/settings/ActivityPicker;->sk:Lcom/android/settings/dc;
