...
.field final rN:Ljava/util/ArrayList;
...
.field wB:Lcom/android/settings/fuelgauge/PowerUsageDetail$DrainType;
...
.field final wy:Ljava/util/HashMap;

.field wz:Landroid/os/BatteryStats$Uid;
...
.method constructor <init>(Landroid/content/Context;Ljava/util/ArrayList;Landroid/os/Handler;Ljava/lang/String;Lcom/android/settings/fuelgauge/PowerUsageDetail$DrainType;ILandroid/os/BatteryStats$Uid;[D)V
    ...
    iput-object v0, p0, Lcom/android/settings/fuelgauge/BatterySipper;->wy:Ljava/util/HashMap;

    .line 66
    iput-object p1, p0, Lcom/android/settings/fuelgauge/BatterySipper;->mContext:Landroid/content/Context;

    .line 67
    iput-object p2, p0, Lcom/android/settings/fuelgauge/BatterySipper;->rN:Ljava/util/ArrayList;

    .line 68
    iput-object p3, p0, Lcom/android/settings/fuelgauge/BatterySipper;->mHandler:Landroid/os/Handler;

    .line 69
    iput-object p8, p0, Lcom/android/settings/fuelgauge/BatterySipper;->wA:[D

    .line 70
    iput-object p4, p0, Lcom/android/settings/fuelgauge/BatterySipper;->name:Ljava/lang/String;

    .line 71
    iput-object p5, p0, Lcom/android/settings/fuelgauge/BatterySipper;->wB:Lcom/android/settings/fuelgauge/PowerUsageDetail$DrainType;
    ...
    .line 79
    :cond_3
    iput-object p7, p0, Lcom/android/settings/fuelgauge/BatterySipper;->wz:Landroid/os/BatteryStats$Uid;
...
.method public a(Lcom/android/settings/fuelgauge/BatterySipper;)I
    ...
    .prologue
    .line 96
    invoke-virtual {p1}, Lcom/android/settings/fuelgauge/BatterySipper;->fZ()D

    move-result-wide v0

    invoke-virtual {p0}, Lcom/android/settings/fuelgauge/BatterySipper;->fZ()D
...
.method a(Landroid/os/BatteryStats$Uid;)V
    ...
    .line 102
    iget-object v2, p0, Lcom/android/settings/fuelgauge/BatterySipper;->wy:Ljava/util/HashMap;
    ...
    .line 103
    iget-object v0, p0, Lcom/android/settings/fuelgauge/BatterySipper;->wy:Ljava/util/HashMap;
    ...
    iput-object v1, p0, Lcom/android/settings/fuelgauge/BatterySipper;->wL:Ljava/lang/String;
    ...
    .line 126
    :cond_3
    iget-object v1, p0, Lcom/android/settings/fuelgauge/BatterySipper;->rN:Ljava/util/ArrayList;

    monitor-enter v1

    .line 127
    :try_start_0
    iget-object v0, p0, Lcom/android/settings/fuelgauge/BatterySipper;->rN:Ljava/util/ArrayList;
...
.method ga()V
    ...
    .line 137
    iget-object v0, p0, Lcom/android/settings/fuelgauge/BatterySipper;->wz:Landroid/os/BatteryStats$Uid;
    ...
    iput-object v7, p0, Lcom/android/settings/fuelgauge/BatterySipper;->wL:Ljava/lang/String;
    ...
    .line 196
    iget-object v2, p0, Lcom/android/settings/fuelgauge/BatterySipper;->wL:Ljava/lang/String;
    ...
    .line 182
    iput-object v3, p0, Lcom/android/settings/fuelgauge/BatterySipper;->wL:Ljava/lang/String;
