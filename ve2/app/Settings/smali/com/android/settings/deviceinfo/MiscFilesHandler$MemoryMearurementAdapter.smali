...
.method public constructor <init>(Lcom/android/settings/deviceinfo/MiscFilesHandler;Landroid/app/Activity;)V
    ...
    .prologue
    .line 192
    iput-object p1, p0, Lcom/android/settings/deviceinfo/MiscFilesHandler$MemoryMearurementAdapter;->nw:Lcom/android/settings/deviceinfo/MiscFilesHandler;
    ...
    iput-object v0, p0, Lcom/android/settings/deviceinfo/MiscFilesHandler$MemoryMearurementAdapter;->ch:Ljava/util/ArrayList;

    .line 189
    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/android/settings/deviceinfo/MiscFilesHandler$MemoryMearurementAdapter;->nv:J
    ...
    invoke-static {p2, v0, v1}, Lcom/android/settings/deviceinfo/StorageMeasurement;->a(Landroid/content/Context;Landroid/os/storage/StorageVolume;Z)Lcom/android/settings/deviceinfo/StorageMeasurement;
    ...
    .line 199
    :cond_1
    iget-object v0, v0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bO:Ljava/util/List;
    ...
    .line 200
    iget-object v0, p0, Lcom/android/settings/deviceinfo/MiscFilesHandler$MemoryMearurementAdapter;->ch:Ljava/util/ArrayList;
    ...
    .line 202
    iget-wide v2, p0, Lcom/android/settings/deviceinfo/MiscFilesHandler$MemoryMearurementAdapter;->nv:J

    iget-wide v4, v0, Lcom/android/settings/deviceinfo/StorageMeasurement$FileInfo;->mSize:J

    add-long/2addr v2, v4

    iput-wide v2, p0, Lcom/android/settings/deviceinfo/MiscFilesHandler$MemoryMearurementAdapter;->nv:J
...
# virtual methods
.method public G(I)Lcom/android/settings/deviceinfo/StorageMeasurement$FileInfo;
    .locals 1
    .parameter
...
.method public dq()J
    ...
    .prologue
    .line 239
    iget-wide v0, p0, Lcom/android/settings/deviceinfo/MiscFilesHandler$MemoryMearurementAdapter;->nv:J
...
.method public e(Ljava/util/List;)V
    ...
    .line 233
    iget-object v2, p0, Lcom/android/settings/deviceinfo/MiscFilesHandler$MemoryMearurementAdapter;->ch:Ljava/util/ArrayList;
...
.method public bridge synthetic getItem(I)Ljava/lang/Object;
    ...
    .prologue
    .line 187
    invoke-virtual {p0, p1}, Lcom/android/settings/deviceinfo/MiscFilesHandler$MemoryMearurementAdapter;->G(I)Lcom/android/settings/deviceinfo/StorageMeasurement$FileInfo;
...
.method public getItemId(I)J
    ...
    iget-wide v0, v0, Lcom/android/settings/deviceinfo/StorageMeasurement$FileInfo;->aT:J
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object v0, p0, Lcom/android/settings/deviceinfo/MiscFilesHandler$MemoryMearurementAdapter;->nw:Lcom/android/settings/deviceinfo/MiscFilesHandler;
    ...
    .line 253
    iget-object v2, v1, Lcom/android/settings/deviceinfo/StorageMeasurement$FileInfo;->aS:Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/deviceinfo/FileItemInfoLayout;->K(Ljava/lang/String;)V

    .line 255
    check-cast p3, Landroid/widget/ListView;

    .line 257
    invoke-virtual {v0}, Lcom/android/settings/deviceinfo/FileItemInfoLayout;->eB()Landroid/widget/CheckBox;
