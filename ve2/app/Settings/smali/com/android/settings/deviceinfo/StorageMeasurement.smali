...
.field private static final bA:Landroid/content/ComponentName;

.field private static bC:Ljava/util/Map;

.field private static bD:Lcom/android/settings/deviceinfo/StorageMeasurement;


# instance fields
.field private final bB:Lcom/android/settings/deviceinfo/StorageMeasurement$MeasurementHandler;

.field private volatile bE:Ljava/lang/ref/WeakReference;
...
.field private final bL:Landroid/os/storage/StorageVolume;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bA:Landroid/content/ComponentName;
    ...
    sput-object v0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bC:Ljava/util/Map;
...
.method private constructor <init>(Landroid/content/Context;Landroid/os/storage/StorageVolume;Z)V
    ...
    iput-object v0, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bK:[J

    .line 114
    iput-object p2, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bL:Landroid/os/storage/StorageVolume;
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bN:Z

    .line 116
    iget-boolean v0, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bN:Z
    ...
    :goto_1
    iput-boolean v1, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bM:Z
    ...
    iput-object v1, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bB:Lcom/android/settings/deviceinfo/StorageMeasurement$MeasurementHandler;
...
.method static synthetic a(Lcom/android/settings/deviceinfo/StorageMeasurement;J)J
    ...
    .prologue
    .line 64
    iput-wide p1, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bH:J
...
.method public static a(Landroid/content/Context;Landroid/os/storage/StorageVolume;Z)Lcom/android/settings/deviceinfo/StorageMeasurement;
    ...
    .line 133
    sget-object v0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bD:Lcom/android/settings/deviceinfo/StorageMeasurement;
    ...
    sput-object v0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bD:Lcom/android/settings/deviceinfo/StorageMeasurement;
    ...
    .line 139
    :cond_1
    sget-object v0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bC:Ljava/util/Map;
    ...
    .line 144
    sget-object v1, Lcom/android/settings/deviceinfo/StorageMeasurement;->bC:Ljava/util/Map;
...
.method private a(Lcom/android/internal/app/IMediaContainerService;)V
    ...
    iget-object v1, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bL:Landroid/os/storage/StorageVolume;
    ...
    iput-object v1, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bO:Ljava/util/List;
    ...
    .line 512
    iget-object v11, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bO:Ljava/util/List;
    ...
    .line 513
    iget-wide v0, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bJ:J

    add-long/2addr v0, v2

    iput-wide v0, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bJ:J
    ...
    .line 523
    :cond_4
    iget-object v0, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bO:Ljava/util/List;
...
.method static synthetic b(Lcom/android/settings/deviceinfo/StorageMeasurement;J)J
    ...
    .prologue
    .line 64
    iput-wide p1, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bF:J
...
.method static synthetic c(Lcom/android/settings/deviceinfo/StorageMeasurement;J)J
    ...
    .prologue
    .line 64
    iput-wide p1, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bG:J
...
.method static synthetic c(Lcom/android/settings/deviceinfo/StorageMeasurement;)Landroid/os/storage/StorageVolume;
    ...
    .prologue
    .line 64
    iget-object v0, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bL:Landroid/os/storage/StorageVolume;
...
.method static synthetic d(Lcom/android/settings/deviceinfo/StorageMeasurement;J)J
    ...
    .prologue
    .line 64
    iput-wide p1, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bI:J
...
.method static synthetic e(Lcom/android/settings/deviceinfo/StorageMeasurement;J)J
    ...
    .prologue
    .line 64
    iput-wide p1, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bJ:J
...
.method static synthetic e(Lcom/android/settings/deviceinfo/StorageMeasurement;)Z
    ...
    .prologue
    .line 64
    iget-boolean v0, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bM:Z
...
.method static synthetic f(Lcom/android/settings/deviceinfo/StorageMeasurement;)[J
    ...
    .prologue
    .line 64
    iget-object v0, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bK:[J
...
.method private s()V
    ...
    .prologue
    .line 172
    iget-object v0, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bE:Ljava/lang/ref/WeakReference;
    ...
    iget-wide v3, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bF:J
    ...
    iget-wide v3, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bG:J
...
.method private t()V
    ...
    iget-wide v3, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bH:J
    ...
    iget-wide v3, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bI:J
    ...
    iget-wide v3, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bJ:J
    ...
    iget-object v3, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bK:[J

    invoke-virtual {v1, v2, v3}, Landroid/os/Bundle;->putLongArray(Ljava/lang/String;[J)V

    .line 201
    invoke-interface {v0, v1}, Lcom/android/settings/deviceinfo/StorageMeasurement$MeasurementReceiver;->c(Landroid/os/Bundle;)V

    goto :goto_1
.end method

.method static synthetic w()Landroid/content/ComponentName;
    .locals 1

    .prologue
    .line 64
    sget-object v0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bA:Landroid/content/ComponentName;
...
.method public a(Lcom/android/settings/deviceinfo/StorageMeasurement$MeasurementReceiver;)V
    ...
    iput-object v0, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bE:Ljava/lang/ref/WeakReference;
...
.method public invalidate()V
    ...
    .prologue
    .line 168
    iget-object v0, p0, Lcom/android/settings/deviceinfo/StorageMeasurement;->bB:Lcom/android/settings/deviceinfo/StorageMeasurement$MeasurementHandler;
