...
# instance fields
.field private KQ:Landroid/preference/Preference;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lcom/android/settings/bw;-><init>(Lcom/android/settings/DockSettings;)V
...
.method static synthetic a(Lcom/android/settings/DockSettings;Landroid/content/Intent;)V
    ...
    .prologue
    .line 37
    invoke-direct {p0, p1}, Lcom/android/settings/DockSettings;->l(Landroid/content/Intent;)V
...
.method private jy()V
    ...
    iput-object v0, p0, Lcom/android/settings/DockSettings;->KQ:Landroid/preference/Preference;

    .line 82
    iget-object v0, p0, Lcom/android/settings/DockSettings;->KQ:Landroid/preference/Preference;
    ...
    iput-object v0, p0, Lcom/android/settings/DockSettings;->KR:Landroid/preference/CheckBoxPreference;

    .line 87
    iget-object v0, p0, Lcom/android/settings/DockSettings;->KR:Landroid/preference/CheckBoxPreference;

    invoke-virtual {v0, v1}, Landroid/preference/CheckBoxPreference;->setPersistent(Z)V

    .line 88
    iget-object v3, p0, Lcom/android/settings/DockSettings;->KR:Landroid/preference/CheckBoxPreference;
...
.method private jz()Landroid/app/Dialog;
    .locals 3
...
.method private l(Landroid/content/Intent;)V
    ...
    .line 93
    iget-object v1, p0, Lcom/android/settings/DockSettings;->KQ:Landroid/preference/Preference;
    ...
    .line 105
    iput-object p1, p0, Lcom/android/settings/DockSettings;->KS:Landroid/content/Intent;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 60
    invoke-direct {p0}, Lcom/android/settings/DockSettings;->jy()V
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    .line 159
    invoke-direct {p0}, Lcom/android/settings/DockSettings;->jz()Landroid/app/Dialog;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 136
    iget-object v2, p0, Lcom/android/settings/DockSettings;->KQ:Landroid/preference/Preference;

    if-ne p2, v2, :cond_3

    .line 137
    iget-object v2, p0, Lcom/android/settings/DockSettings;->KS:Landroid/content/Intent;
    ...
    iget-object v1, p0, Lcom/android/settings/DockSettings;->KS:Landroid/content/Intent;
    ...
    .line 148
    :cond_3
    iget-object v2, p0, Lcom/android/settings/DockSettings;->KR:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v4, p0, Lcom/android/settings/DockSettings;->KR:Landroid/preference/CheckBoxPreference;
