...
.field private AK:Lcom/android/settings/cw;

.field private AL:Landroid/content/DialogInterface;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/BandMode;->AH:[Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    .line 51
    iput-object v0, p0, Lcom/android/settings/BandMode;->AK:Lcom/android/settings/cw;
    ...
    invoke-direct {v0, p0}, Lcom/android/settings/bb;-><init>(Lcom/android/settings/BandMode;)V

    iput-object v0, p0, Lcom/android/settings/BandMode;->AM:Landroid/widget/AdapterView$OnItemClickListener;

    .line 193
    new-instance v0, Lcom/android/settings/ba;

    invoke-direct {v0, p0}, Lcom/android/settings/ba;-><init>(Lcom/android/settings/BandMode;)V
...
.method static synthetic a(Lcom/android/settings/BandMode;Lcom/android/settings/cw;)Lcom/android/settings/cw;
    .locals 0
    .parameter
    .parameter
    ...
    .prologue
    .line 33
    iput-object p1, p0, Lcom/android/settings/BandMode;->AK:Lcom/android/settings/cw;
...
.method private a(Landroid/os/AsyncResult;)V
    ...
    .line 135
    iget-object v0, p0, Lcom/android/settings/BandMode;->AL:Landroid/content/DialogInterface;
    ...
    .line 137
    :cond_0
    invoke-direct {p0}, Lcom/android/settings/BandMode;->hb()V
    ...
    .line 148
    new-instance v5, Lcom/android/settings/cw;

    aget v6, v0, v3

    invoke-direct {v5, v6}, Lcom/android/settings/cw;-><init>(I)V

    .line 149
    iget-object v6, p0, Lcom/android/settings/BandMode;->AJ:Landroid/widget/ArrayAdapter;
    ...
    .line 159
    new-instance v1, Lcom/android/settings/cw;

    invoke-direct {v1, v0}, Lcom/android/settings/cw;-><init>(I)V

    .line 160
    iget-object v2, p0, Lcom/android/settings/BandMode;->AJ:Landroid/widget/ArrayAdapter;
    ...
    .line 164
    :cond_2
    iget-object v0, p0, Lcom/android/settings/BandMode;->AI:Landroid/widget/ListView;
...
.method private a(Ljava/lang/Throwable;)V
    ...
    iget-object v1, p0, Lcom/android/settings/BandMode;->AK:Lcom/android/settings/cw;

    invoke-virtual {v1}, Lcom/android/settings/cw;->toString()Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/settings/BandMode;->AL:Landroid/content/DialogInterface;
...
.method static synthetic b(Lcom/android/settings/BandMode;)Lcom/android/settings/cw;
    .locals 1
    .parameter

    .prologue
    .line 33
    iget-object v0, p0, Lcom/android/settings/BandMode;->AK:Lcom/android/settings/cw;
...
.method private hb()V
    ...
    .line 183
    :goto_0
    iget-object v0, p0, Lcom/android/settings/BandMode;->AJ:Landroid/widget/ArrayAdapter;
    ...
    iget-object v1, p0, Lcom/android/settings/BandMode;->AJ:Landroid/widget/ArrayAdapter;
...
.method static synthetic hc()[Ljava/lang/String;
    .locals 1

    .prologue
    .line 33
    sget-object v0, Lcom/android/settings/BandMode;->AH:[Ljava/lang/String;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/BandMode;->AI:Landroid/widget/ListView;
    ...
    iput-object v0, p0, Lcom/android/settings/BandMode;->AJ:Landroid/widget/ArrayAdapter;
    ...
    iget-object v1, p0, Lcom/android/settings/BandMode;->AM:Landroid/widget/AdapterView$OnItemClickListener;

    invoke-virtual {v0, v1}, Landroid/widget/ListView;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V

    .line 78
    invoke-direct {p0}, Lcom/android/settings/BandMode;->ha()V
