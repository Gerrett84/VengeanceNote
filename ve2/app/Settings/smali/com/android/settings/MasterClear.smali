...
.field private final mF:Landroid/view/View$OnClickListener;

.field private xO:Landroid/view/View;

.field private xP:Landroid/widget/CheckBox;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lcom/android/settings/dK;-><init>(Lcom/android/settings/MasterClear;)V

    iput-object v0, p0, Lcom/android/settings/MasterClear;->mF:Landroid/view/View$OnClickListener;
...
.method static synthetic a(Lcom/android/settings/MasterClear;)V
    ...
    .prologue
    .line 55
    invoke-direct {p0}, Lcom/android/settings/MasterClear;->cU()V
...
.method static synthetic a(Lcom/android/settings/MasterClear;I)Z
    ...
    .prologue
    .line 55
    invoke-direct {p0, p1}, Lcom/android/settings/MasterClear;->z(I)Z
...
.method static synthetic b(Lcom/android/settings/MasterClear;)Landroid/widget/CheckBox;
    ...
    .prologue
    .line 55
    iget-object v0, p0, Lcom/android/settings/MasterClear;->xP:Landroid/widget/CheckBox;
...
.method private cU()V
    ...
    iget-object v3, p0, Lcom/android/settings/MasterClear;->xP:Landroid/widget/CheckBox;
...
.method private go()V
    ...
    .line 135
    iget-object v0, p0, Lcom/android/settings/MasterClear;->mC:Landroid/widget/Button;

    iget-object v2, p0, Lcom/android/settings/MasterClear;->mF:Landroid/view/View$OnClickListener;

    invoke-virtual {v0, v2}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 136
    iget-object v0, p0, Lcom/android/settings/MasterClear;->mB:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/settings/MasterClear;->xO:Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/settings/MasterClear;->xP:Landroid/widget/CheckBox;
    ...
    invoke-direct {p0}, Lcom/android/settings/MasterClear;->cX()Z
    ...
    .line 149
    :cond_0
    iget-object v2, p0, Lcom/android/settings/MasterClear;->xO:Landroid/view/View;

    invoke-virtual {v2, v4}, Landroid/view/View;->setVisibility(I)V

    .line 151
    iget-object v2, p0, Lcom/android/settings/MasterClear;->mB:Landroid/view/View;
    ...
    .line 159
    iget-object v2, p0, Lcom/android/settings/MasterClear;->xP:Landroid/widget/CheckBox;
    ...
    .line 170
    :goto_1
    invoke-direct {p0}, Lcom/android/settings/MasterClear;->gp()V
    ...
    .line 161
    :cond_2
    iget-object v0, p0, Lcom/android/settings/MasterClear;->xO:Landroid/view/View;

    new-instance v1, Lcom/android/settings/dL;

    invoke-direct {v1, p0}, Lcom/android/settings/dL;-><init>(Lcom/android/settings/MasterClear;)V
...
.method private z(I)Z
    ...
    invoke-direct {v1, v2, p0}, Lcom/android/settings/ch;-><init>(Landroid/app/Activity;Landroid/app/Fragment;)V
    ...
    invoke-virtual {v1, p1, v2, v0}, Lcom/android/settings/ch;->launchConfirmationActivity(ILjava/lang/CharSequence;Ljava/lang/CharSequence;)Z
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 94
    :cond_1
    invoke-direct {p0}, Lcom/android/settings/MasterClear;->go()V
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v0, p0, Lcom/android/settings/MasterClear;->mB:Landroid/view/View;
