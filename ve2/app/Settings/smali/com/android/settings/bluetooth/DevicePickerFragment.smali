...
.method private k(Landroid/bluetooth/BluetoothDevice;)V
    ...
    .line 104
    iget-object v1, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->ld:Ljava/lang/String;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->le:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->le:Ljava/lang/String;
...
.method S()V
    ...
    iput-boolean v1, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->lc:Z
    ...
    iput-object v1, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->ld:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->le:Ljava/lang/String;
...
.method a(Lcom/android/settings/bluetooth/BluetoothDevicePreference;)V
    ...
    iget-object v1, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->cV:Landroid/bluetooth/BluetoothDevice;

    invoke-virtual {v1}, Landroid/bluetooth/BluetoothDevice;->getAddress()Ljava/lang/String;

    move-result-object v1

    invoke-static {v0, v1}, Lcom/android/settings/bluetooth/LocalBluetoothPreferences;->b(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iget-boolean v0, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->lc:Z

    if-nez v0, :cond_1

    .line 74
    :cond_0
    iget-object v0, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->cV:Landroid/bluetooth/BluetoothDevice;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->lf:Z
...
.method public onResume()V
    ...
    .line 60
    invoke-virtual {p0}, Lcom/android/settings/bluetooth/DevicePickerFragment;->U()V

    .line 61
    iget-boolean v0, p0, Lcom/android/settings/bluetooth/DevicePickerFragment;->lf:Z
