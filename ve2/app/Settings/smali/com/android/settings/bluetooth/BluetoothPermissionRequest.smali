...
# instance fields
.field jj:Landroid/bluetooth/BluetoothDevice;
...
.method public constructor <init>()V
    ...
    .line 44
    iput-object v0, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->yt:Ljava/lang/String;

    .line 45
    iput-object v0, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->yu:Ljava/lang/String;
...
.method private a(Ljava/lang/String;ZLjava/lang/String;Z)V
    ...
    .line 171
    iget-object v0, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->yt:Ljava/lang/String;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->yu:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->yu:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->jj:Landroid/bluetooth/BluetoothDevice;
...
.method private gu()Z
    ...
    .line 129
    .line 132
    iget v0, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->ys:I
    ...
    .line 137
    invoke-virtual {v3}, Lcom/android/settings/bluetooth/LocalBluetoothManager;->dK()Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;

    move-result-object v4

    .line 139
    iget-object v0, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->jj:Landroid/bluetooth/BluetoothDevice;
    ...
    .line 142
    invoke-virtual {v3}, Lcom/android/settings/bluetooth/LocalBluetoothManager;->dH()Lcom/android/settings/bluetooth/LocalBluetoothAdapter;

    move-result-object v0

    invoke-virtual {v3}, Lcom/android/settings/bluetooth/LocalBluetoothManager;->dM()Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;

    move-result-object v3

    iget-object v5, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->jj:Landroid/bluetooth/BluetoothDevice;
    ...
    .line 146
    :cond_2
    invoke-virtual {v0}, Lcom/android/settings/bluetooth/CachedBluetoothDevice;->fn()I
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->jj:Landroid/bluetooth/BluetoothDevice;
    ...
    iput v0, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->ys:I
    ...
    iget v1, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->ys:I
    ...
    iget-object v1, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->jj:Landroid/bluetooth/BluetoothDevice;
    ...
    iget-object v1, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->yt:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->yu:Ljava/lang/String;

    invoke-virtual {v3, v0, v1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    .line 74
    invoke-direct {p0}, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->gu()Z
    ...
    invoke-static {p1, v1}, Lcom/android/settings/bluetooth/LocalBluetoothPreferences;->a(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    iget-object v4, p0, Lcom/android/settings/bluetooth/BluetoothPermissionRequest;->jj:Landroid/bluetooth/BluetoothDevice;
