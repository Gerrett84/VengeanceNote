...
# static fields
.field private static qc:Lcom/android/settings/bluetooth/LocalBluetoothManager;
...
.field private qd:Landroid/content/Context;

.field private final qe:Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;
...
.method private constructor <init>(Lcom/android/settings/bluetooth/LocalBluetoothAdapter;Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothManager;->qe:Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;
    ...
    iget-object v2, p0, Lcom/android/settings/bluetooth/LocalBluetoothManager;->qe:Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothManager;->qf:Lcom/android/settings/bluetooth/BluetoothEventManager;
    ...
    iget-object v3, p0, Lcom/android/settings/bluetooth/LocalBluetoothManager;->qf:Lcom/android/settings/bluetooth/BluetoothEventManager;
...
.method public static declared-synchronized t(Landroid/content/Context;)Lcom/android/settings/bluetooth/LocalBluetoothManager;
    ...
    :try_start_0
    sget-object v0, Lcom/android/settings/bluetooth/LocalBluetoothManager;->qc:Lcom/android/settings/bluetooth/LocalBluetoothManager;
    ...
    sput-object v3, Lcom/android/settings/bluetooth/LocalBluetoothManager;->qc:Lcom/android/settings/bluetooth/LocalBluetoothManager;
...
.method public ep()Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;
    .locals 1
...
.method public eq()Lcom/android/settings/bluetooth/LocalBluetoothAdapter;
    .locals 1
...
.method public er()Landroid/content/Context;
    .locals 1

    .prologue
    .line 93
    iget-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothManager;->qd:Landroid/content/Context;
...
.method et()Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;
    .locals 1

    .prologue
    .line 113
    iget-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothManager;->qe:Lcom/android/settings/bluetooth/CachedBluetoothDeviceManager;

    return-object v0
.end method

.method eu()Lcom/android/settings/bluetooth/BluetoothEventManager;
    .locals 1

    .prologue
    .line 117
    iget-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothManager;->qf:Lcom/android/settings/bluetooth/BluetoothEventManager;

    return-object v0
.end method

.method ev()Lcom/android/settings/bluetooth/LocalBluetoothProfileManager;
    .locals 1
...
.method declared-synchronized u(Landroid/content/Context;)V
    ...
    .line 103
    iput-object p1, p0, Lcom/android/settings/bluetooth/LocalBluetoothManager;->qd:Landroid/content/Context;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/LocalBluetoothManager;->qd:Landroid/content/Context;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
