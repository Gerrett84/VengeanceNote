...
# instance fields
.field M:Lcom/android/settings/bluetooth/LocalBluetoothAdapter;

.field private cU:Lcom/android/settings/bluetooth/BluetoothDeviceFilter$Filter;

.field cV:Landroid/bluetooth/BluetoothDevice;

.field cW:Lcom/android/settings/bluetooth/LocalBluetoothManager;

.field private cX:Landroid/preference/PreferenceGroup;

.field final cY:Ljava/util/WeakHashMap;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->cY:Ljava/util/WeakHashMap;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->cU:Lcom/android/settings/bluetooth/BluetoothDeviceFilter$Filter;
...
.method private h(Z)V
    ...
    .prologue
    .line 196
    iget-object v0, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->cX:Landroid/preference/PreferenceGroup;
    ...
    invoke-virtual {v0, p1}, Lcom/android/settings/ProgressCategory;->O(Z)V
...
.method T()V
    ...
    .line 119
    iget-object v0, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->cY:Ljava/util/WeakHashMap;
...
.method U()V
    ...
    .prologue
    .line 124
    iget-object v0, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->cW:Lcom/android/settings/bluetooth/LocalBluetoothManager;
...
.method a(Landroid/preference/PreferenceGroup;)V
    ...
    .prologue
    .line 90
    iput-object p1, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->cX:Landroid/preference/PreferenceGroup;
...
.method final a(Lcom/android/settings/bluetooth/BluetoothDeviceFilter$Filter;)V
    ...
    .prologue
    .line 66
    iput-object p1, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->cU:Lcom/android/settings/bluetooth/BluetoothDeviceFilter$Filter;
...
.method a(Lcom/android/settings/bluetooth/BluetoothDevicePreference;)V
    ...
    .prologue
    .line 151
    invoke-virtual {p1}, Lcom/android/settings/bluetooth/BluetoothDevicePreference;->iq()V
...
.method public b(Lcom/android/settings/bluetooth/CachedBluetoothDevice;)V
    ...
    .line 162
    iget-object v0, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->cU:Lcom/android/settings/bluetooth/BluetoothDeviceFilter$Filter;
...
.method c(Lcom/android/settings/bluetooth/CachedBluetoothDevice;)V
    ...
    .line 172
    iget-object v1, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->cX:Landroid/preference/PreferenceGroup;

    invoke-virtual {v1, v0}, Landroid/preference/PreferenceGroup;->addPreference(Landroid/preference/Preference;)Z

    .line 173
    iget-object v1, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->cY:Ljava/util/WeakHashMap;
...
.method final g(I)V
    ...
    .prologue
    .line 70
    invoke-static {p1}, Lcom/android/settings/bluetooth/BluetoothDeviceFilter;->S(I)Lcom/android/settings/bluetooth/BluetoothDeviceFilter$Filter;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->cW:Lcom/android/settings/bluetooth/LocalBluetoothManager;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->M:Lcom/android/settings/bluetooth/LocalBluetoothAdapter;

    .line 84
    invoke-virtual {p0}, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->S()V
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->cX:Landroid/preference/PreferenceGroup;
...
.method public onPause()V
    ...
    invoke-virtual {v0}, Lcom/android/settings/bluetooth/LocalBluetoothManager;->dL()Lcom/android/settings/bluetooth/BluetoothEventManager;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    invoke-virtual {v1, v0}, Lcom/android/settings/bluetooth/LocalBluetoothAdapter;->F(Z)V
    ...
    .line 141
    invoke-virtual {p2}, Lcom/android/settings/bluetooth/BluetoothDevicePreference;->ip()Lcom/android/settings/bluetooth/CachedBluetoothDevice;
    ...
    iput-object v1, p0, Lcom/android/settings/bluetooth/DeviceListPreferenceFragment;->cV:Landroid/bluetooth/BluetoothDevice;
