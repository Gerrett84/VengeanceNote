...
.field private final zI:Landroid/preference/Preference;

.field private final zJ:Landroid/content/SharedPreferences;
...
.method constructor <init>(Landroid/content/Context;Lcom/android/settings/bluetooth/LocalBluetoothAdapter;Landroid/preference/Preference;)V
    ...
    iput v0, p0, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->zM:I
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->zN:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->hM:Landroid/os/Handler;

    .line 94
    iput-object p2, p0, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->M:Lcom/android/settings/bluetooth/LocalBluetoothAdapter;

    .line 95
    iput-object p3, p0, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->zI:Landroid/preference/Preference;
    ...
    iput-object v0, p0, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->zJ:Landroid/content/SharedPreferences;
...
.method private ap(I)V
    ...
    .line 145
    iget-object v0, p0, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->zI:Landroid/preference/Preference;
    ...
    .line 147
    :cond_0
    invoke-static {p1}, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->aq(I)Ljava/lang/String;

    move-result-object v0

    .line 148
    iget-object v1, p0, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->zI:Landroid/preference/Preference;
...
.method static synthetic b(Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;)V
    ...
    .prologue
    .line 37
    invoke-direct {p0}, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->gQ()V
...
.method private gP()V
    ...
    .prologue
    .line 251
    iget v0, p0, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->zL:I
...
.method private gQ()V
    ...
    .line 259
    iget-object v0, p0, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->M:Lcom/android/settings/bluetooth/LocalBluetoothAdapter;
    ...
    invoke-static {v2}, Lcom/android/settings/bluetooth/LocalBluetoothPreferences;->o(Landroid/content/Context;)J
    ...
    invoke-direct {p0, v0}, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->ap(I)V
    ...
    .line 277
    :try_start_0
    iget-object v0, p0, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->hM:Landroid/os/Handler;

    iget-object v1, p0, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->zN:Ljava/lang/Runnable;
...
.method private getDiscoverableTimeout()I
    ...
    .line 194
    iget v0, p0, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->zM:I
    ...
    .line 200
    iget-object v0, p0, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->zJ:Landroid/content/SharedPreferences;
...
.method private setEnabled(Z)V
    ...
    .line 131
    iget-object v1, p0, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->M:Lcom/android/settings/bluetooth/LocalBluetoothAdapter;
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/bluetooth/LocalBluetoothAdapter;->H(I)V
...
.method ar(I)V
    ...
    .prologue
    .line 236
    iput p1, p0, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->zL:I
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->as(I)V
...
.method as(I)V
    ...
    iput-boolean v0, p0, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->zK:Z
    ...
    .line 246
    invoke-direct {p0}, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->gP()V
...
.method public onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    .line 123
    iget-boolean v0, p0, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->zK:Z
...
.method setDiscoverableTimeout(I)V
    ...
    .line 189
    :goto_0
    iget-object v1, p0, Lcom/android/settings/bluetooth/BluetoothDiscoverableEnabler;->zJ:Landroid/content/SharedPreferences;
