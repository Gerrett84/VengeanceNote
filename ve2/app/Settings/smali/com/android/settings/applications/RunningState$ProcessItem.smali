...
.field cB:Landroid/app/ActivityManager$RunningAppProcessInfo;
...
.field final cw:Landroid/util/SparseArray;

.field final cx:Ljava/lang/String;

.field cy:Lcom/android/settings/applications/RunningState$ProcessItem;
...
.method public constructor <init>(Landroid/content/Context;ILjava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/android/settings/applications/RunningState$ProcessItem;->cw:Landroid/util/SparseArray;
    ...
    .line 278
    iput-object p3, p0, Lcom/android/settings/applications/RunningState$ProcessItem;->cx:Ljava/lang/String;
...
.method a(Landroid/content/pm/PackageManager;)V
    ...
    .line 282
    iget-object v1, p0, Lcom/android/settings/applications/RunningState$BaseItem;->EC:Ljava/lang/String;
    ...
    :cond_0
    :try_start_0
    iget-object v1, p0, Lcom/android/settings/applications/RunningState$ProcessItem;->cx:Ljava/lang/String;
    ...
    iput-object v2, p0, Lcom/android/settings/applications/RunningState$BaseItem;->EB:Ljava/lang/CharSequence;

    .line 290
    iget-object v2, p0, Lcom/android/settings/applications/RunningState$BaseItem;->EB:Ljava/lang/CharSequence;

    invoke-virtual {v2}, Ljava/lang/Object;->toString()Ljava/lang/String;

    move-result-object v2

    iput-object v2, p0, Lcom/android/settings/applications/RunningState$BaseItem;->EC:Ljava/lang/String;

    .line 291
    iput-object v1, p0, Lcom/android/settings/applications/RunningState$BaseItem;->EA:Landroid/content/pm/PackageItemInfo;
    :try_end_0
    ...
    iput-object v3, p0, Lcom/android/settings/applications/RunningState$BaseItem;->EB:Ljava/lang/CharSequence;

    .line 306
    iget-object v3, p0, Lcom/android/settings/applications/RunningState$BaseItem;->EB:Ljava/lang/CharSequence;

    invoke-virtual {v3}, Ljava/lang/Object;->toString()Ljava/lang/String;

    move-result-object v3

    iput-object v3, p0, Lcom/android/settings/applications/RunningState$BaseItem;->EC:Ljava/lang/String;

    .line 307
    iput-object v2, p0, Lcom/android/settings/applications/RunningState$BaseItem;->EA:Landroid/content/pm/PackageItemInfo;
    :try_end_1
    ...
    iput-object v3, p0, Lcom/android/settings/applications/RunningState$BaseItem;->EA:Landroid/content/pm/PackageItemInfo;
    :try_end_2
    ...
    iget-object v0, v0, Lcom/android/settings/applications/RunningState$ServiceItem;->IT:Landroid/content/pm/ServiceInfo;
    ...
    .line 337
    iget-object v0, p0, Lcom/android/settings/applications/RunningState$BaseItem;->EA:Landroid/content/pm/PackageItemInfo;
    ...
    .line 338
    iget-object v0, p0, Lcom/android/settings/applications/RunningState$BaseItem;->EB:Ljava/lang/CharSequence;
    ...
    iput-object v1, p0, Lcom/android/settings/applications/RunningState$BaseItem;->EB:Ljava/lang/CharSequence;

    .line 346
    iget-object v1, p0, Lcom/android/settings/applications/RunningState$BaseItem;->EB:Ljava/lang/CharSequence;

    invoke-virtual {v1}, Ljava/lang/Object;->toString()Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Lcom/android/settings/applications/RunningState$BaseItem;->EC:Ljava/lang/String;
...
.method a(Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    .prologue
    .line 445
    iget-object v0, p0, Lcom/android/settings/applications/RunningState$ProcessItem;->cw:Landroid/util/SparseArray;
...
.method a(Landroid/content/Context;JI)Z
    ...
    .line 407
    iget v0, p0, Lcom/android/settings/applications/RunningState$BaseItem;->EE:I
...
.method a(Landroid/content/Context;Landroid/app/ActivityManager$RunningServiceInfo;)Z
    ...
    .line 362
    iput-object p2, v2, Lcom/android/settings/applications/RunningState$ServiceItem;->IS:Landroid/app/ActivityManager$RunningServiceInfo;
    ...
    iput-object v0, v2, Lcom/android/settings/applications/RunningState$ServiceItem;->IT:Landroid/content/pm/ServiceInfo;
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_1

    .line 367
    :goto_0
    iget-object v0, v2, Lcom/android/settings/applications/RunningState$ServiceItem;->IS:Landroid/app/ActivityManager$RunningServiceInfo;
    ...
    iget-object v5, v2, Lcom/android/settings/applications/RunningState$ServiceItem;->IT:Landroid/content/pm/ServiceInfo;
    ...
    iput-object v0, v2, Lcom/android/settings/applications/RunningState$BaseItem;->EB:Ljava/lang/CharSequence;
    ...
    .line 370
    iget-object v0, v2, Lcom/android/settings/applications/RunningState$ServiceItem;->IT:Landroid/content/pm/ServiceInfo;

    iget-object v0, v0, Landroid/content/pm/ServiceInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;

    iput-object v0, v2, Lcom/android/settings/applications/RunningState$BaseItem;->EA:Landroid/content/pm/PackageItemInfo;
    ...
    .line 373
    :goto_2
    iget v5, p0, Lcom/android/settings/applications/RunningState$BaseItem;->EE:I

    iput v5, v0, Lcom/android/settings/applications/RunningState$BaseItem;->EE:I

    .line 374
    iput-object p2, v0, Lcom/android/settings/applications/RunningState$ServiceItem;->IS:Landroid/app/ActivityManager$RunningServiceInfo;
    ...
    .line 376
    :goto_3
    iget-wide v8, v0, Lcom/android/settings/applications/RunningState$BaseItem;->cG:J
    ...
    .line 377
    iput-wide v5, v0, Lcom/android/settings/applications/RunningState$BaseItem;->cG:J
    ...
    .line 381
    iget-boolean v5, v0, Lcom/android/settings/applications/RunningState$ServiceItem;->IU:Z

    if-eqz v5, :cond_5

    .line 382
    iput-boolean v4, v0, Lcom/android/settings/applications/RunningState$ServiceItem;->IU:Z
    ...
    iput-object v2, v0, Lcom/android/settings/applications/RunningState$BaseItem;->ED:Ljava/lang/String;
    :try_end_1
    ...
    .line 391
    iput-object v1, v0, Lcom/android/settings/applications/RunningState$BaseItem;->ED:Ljava/lang/String;

    goto :goto_5

    .line 394
    :cond_3
    iget-boolean v1, v0, Lcom/android/settings/applications/RunningState$ServiceItem;->IU:Z

    if-nez v1, :cond_4

    .line 395
    iput-boolean v3, v0, Lcom/android/settings/applications/RunningState$ServiceItem;->IU:Z
...
.method a(Landroid/content/Context;Landroid/content/pm/PackageManager;I)Z
    ...
    .line 422
    iget-object v1, p0, Lcom/android/settings/applications/RunningState$ProcessItem;->cw:Landroid/util/SparseArray;
    ...
    .line 426
    iget-object v5, v0, Lcom/android/settings/applications/RunningState$ProcessItem;->cy:Lcom/android/settings/applications/RunningState$ProcessItem;

    if-eq v5, p0, :cond_0

    .line 428
    iput-object p0, v0, Lcom/android/settings/applications/RunningState$ProcessItem;->cy:Lcom/android/settings/applications/RunningState$ProcessItem;

    move v1, v2

    .line 430
    :cond_0
    iput p3, v0, Lcom/android/settings/applications/RunningState$BaseItem;->EE:I
    ...
    .line 435
    :cond_1
    iget v0, p0, Lcom/android/settings/applications/RunningState$ProcessItem;->cz:I

    iget-object v3, p0, Lcom/android/settings/applications/RunningState$ProcessItem;->cw:Landroid/util/SparseArray;
    ...
    iput v0, p0, Lcom/android/settings/applications/RunningState$ProcessItem;->cz:I
